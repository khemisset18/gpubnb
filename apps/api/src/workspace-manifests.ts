...
export const workspaceManifests:readonly WorkspaceManifest[]=Object.freeze([
 ...
 manifest({slug:'developer',name:'Developer Workspace',icon:'💻',category:'DEVELOPMENT',release:'UPCOMING',summary:'Développement complet à distance',technologies:['VS Code','Git','Node.js','Python'],license:'INCLUDED_OPEN_SOURCE',minimum:{ramMiB:8192,diskMiB:20480,docker:true},recommended:{ramMiB:16384,diskMiB:51200}}),
