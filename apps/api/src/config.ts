...
const schema = z.object({
  ...
  SWEEP_INTERVAL_MS: z.coerce.number().int().min(5_000).max(3_600_000).default(30_000),
  SWEEP_LOCK_TTL_MS: z.coerce.number().int().min(5_000).max(600_000).default(60_000),
