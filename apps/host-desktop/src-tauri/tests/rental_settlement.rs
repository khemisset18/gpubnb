...
fn two_month_rental_can_settle_full_service() {
    ...
    let mut meter = AvailabilityMeter::new(SettlementTerms {
        ...
        prepaid_amount_minor_units: 12_000_00,
    ...
    assert_eq!(settlement.host_payout_minor_units, 12_000_00);
...
fn host_is_paid_only_for_verified_machine_uptime() {
    ...
    assert_eq!(settlement.host_payout_minor_units, 9_000_00);
    assert_eq!(settlement.renter_refund_minor_units, 3_000_00);
}
