...
For Windows physical beta qualification after the 2026-09-09 heartbeat incident, use Agent `0.6.4` or newer so the test is not performed with the known console-flash / expensive-inventory behavior from 0.6.3.
