...
class ExecutionControlPolicyTests(unittest.TestCase):
    ...
    def test_tls_verification_uses_validated_public_ip_and_original_hostname(self) -> None:
    ...
    def test_plain_tcp_pool_never_performs_tls_handshake(self) -> None:
        with patch("gpubnb_agent.execution_control._tls_connect") as connect:
            _verify_pool_tls(
    ...
    def test_tls_verification_fails_closed_when_every_validated_address_fails(self) -> None:
        with patch(
